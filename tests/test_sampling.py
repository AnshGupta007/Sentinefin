...
def test_sample_raw_dataset_reproducibility(raw_complaints_csv, tmp_path):
    ...
    sample_raw_dataset(input_path=raw_complaints_csv, output_path=out1, target_size=15, min_words=5, seed=123, chunk_size=30, chunk_step=1)
    sample_raw_dataset(input_path=raw_complaints_csv, output_path=out2, target_size=15, min_words=5, seed=123, chunk_size=30, chunk_step=1)
